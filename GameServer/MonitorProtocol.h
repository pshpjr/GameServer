...
enum en_PACKET_SS_MONITOR_DATA_UPDATE_TYPE : BYTE
{
	...
	dfMONITOR_DATA_TYPE_CHAT_ACCEPT_TPS = 138,
	...
	dfMONITOR_DATA_TYPE_GAME_SERVER_ACCEPT = 142,		// GameServer AcceptTps
	dfMONITOR_DATA_TYPE_GAME_SERVER_DISCONNECT = 143,		// GameServer DisconnectTps
	dfMONITOR_DATA_TYPE_GAME_SERVER_SEND = 144,		// GameServer DisconnectTps
	dfMONITOR_DATA_TYPE_GAME_SERVER_RECV= 145,		// GameServer DisconnectTps
