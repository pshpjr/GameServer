...
psh::HardMonsterGroup::HardMonsterGroup(Server& server
...
void psh::HardMonsterGroup::UpdateContent(int deltaMs)
{
...
psh::HardMonsterGroup::~HardMonsterGroup() = default;

void psh::HardMonsterGroup::OnRecv(SessionID id, CRecvBuffer& recvBuffer)
{
    ePacketType type;
    recvBuffer >> type;
    switch (type)
