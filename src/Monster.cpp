...
namespace psh
{
    const Nickname& GetMonsterName(TemplateID id)
    {
        static const std::array monsterNames = {
            ...
            Nickname("Easy_1"), Nickname("Easy_2"), Nickname("Easy_3"), Nickname("Easy_4"), // 4~7
            Nickname("Hard_1"), Nickname("Hard_2"), Nickname("Hard_3"), Nickname("Hard_4"), // 8~11
            Nickname("PVP_1"), Nickname("PVP_2"), Nickname("PVP_3"), Nickname("PVP_4") // 12~15
        };
