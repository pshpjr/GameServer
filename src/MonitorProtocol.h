...
enum en_PACKET_SS_MONITOR_DATA_UPDATE_TYPE : BYTE
{
    ...
    dfMONITOR_DATA_TYPE_GAME_CHAT_COUNT, dfMONITOR_DATA_TYPE_GAME_MOVE_COUNT, dfMONITOR_DATA_TYPE_GAME_ATTACK_COUNT
    , dfMONITOR_DATA_TYPE_GAME_DUMMY_DELAY_AVG, dfMONITOR_DATA_TYPE_GAME_DUMMY_DELAY_MAX
    , dfMONITOR_END
};
